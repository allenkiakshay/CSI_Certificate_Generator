...
const ImageUploadComponent = () => {
  ...
  const addTextInput = () => {
    setTextInputs([
      ...textInputs,
      { text: "", size: "", fontfam: "", colour: "", position: { x: 0, y: 0 } },
    ]);
  };
      ...
      await new Promise((resolve) => {
        ...
        setTimeout(() => {
          ...
          html2canvas(imageContainer, { scale: scale }).then((canvas) => {
            const imgData = canvas.toDataURL("image/png");
            zip.file(`${id}.png`, imgData.split("base64,")[1], {
              base64: true,
            });
            resolve();
          });
  ...
  return (
    <div>
      <div className="flex w-[100%] h-[100%] bg-black">
        <div
          className="flex flex-col w-[75vw] h-[100vh] bg-white justify-center items-center"
        ...
        >
          ...
          >
            <h1
              style={{
                fontSize: `${CertIdsize}px`,
                fontFamily: `${CertIdfontfam}`,
                color: `${CertIdcolour}`,
                width: "fit-content",
              }}
            >
        ...
        <div className="flex w-[fit] h-[100vh] bg-black flex-col m-[20px] overflow-auto">
          <div className="flex w-[fit] h-[90vh] bg-black flex-col m-[20px] overflow-auto">
            ...
            <input
              type="text"
              value={Namefontfam}
              onChange={(e) => setNameFontfam(e.target.value)}
            ...
            <input
              type="text"
              value={Namecolour}
              onChange={(e) => setNameColour(e.target.value)}
            ...
            <input
              type="text"
              value={CertIdsize}
              onChange={(e) => setCertIdSize(e.target.value)}
              placeholder="Type Font Size"
              onClick={(e) => e.stopPropagation()}
              className="w-[300px] h-[60px] m-[20px] text-center mb-2 bg-black border-[2px] border-white text-white"
            />
            <input
              type="text"
              value={CertIdfontfam}
              onChange={(e) => setCertIdFontfam(e.target.value)}
              placeholder="Type Font Family"
              onClick={(e) => e.stopPropagation()}
              className="w-[300px] h-[60px] m-[20px] text-center mb-2 bg-black border-[2px] border-white text-white"
            />
            <input
              type="text"
              value={CertIdcolour}
              onChange={(e) => setCertIdColour(e.target.value)}
              placeholder="Type Font Colour"
              onClick={(e) => e.stopPropagation()}
              className="w-[300px] h-[60px] m-[20px] text-center mb-2 bg-black border-[2px] border-white text-white"
            />
          ...
          <button
            ...
            className="bottom-[5%] left-[40vw] m-[5px] pt-4 pb-4 pl-11 rounded-[12px] text-[#121212] bg-gradient-to-r from-[#58D7FC] to-[#F8FFA3] text-center"
          >
            Add a Field
          </button>
          <button
            onClick={downloadAsImage}
            className="bottom-[5%] left-[40vw] m-[5px] pt-4 pb-4 pl-11 rounded-[12px] text-[#121212] bg-gradient-to-r from-[#58D7FC] to-[#F8FFA3]"
          >
            Download Sample
          </button>
          <button
