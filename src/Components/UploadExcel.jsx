        ...
        const columnA = XLSX.utils
          .sheet_to_json(sheet, {
            ...
            range: sheet["!ref"]
              ? {
                  s: { c: 0, r: 1 },
                  e: { c: 0, r: XLSX.utils.decode_range(sheet["!ref"]).e.r },
                }
              : null,
            raw: false,
          })
        ...
        const columnB = XLSX.utils
          .sheet_to_json(sheet, {
            ...
            range: sheet["!ref"]
              ? {
                  s: { c: 1, r: 1 },
                  e: { c: 1, r: XLSX.utils.decode_range(sheet["!ref"]).e.r },
                }
              : null,
            raw: false,
          })
        ...
        const columnC = XLSX.utils
          .sheet_to_json(sheet, {
            ...
            range: sheet["!ref"]
              ? {
                  s: { c: 2, r: 1 },
                  e: { c: 2, r: XLSX.utils.decode_range(sheet["!ref"]).e.r },
                }
              : null,
            raw: false,
          })
        ...
        {names.length === 0 ? (
          <div className="grid place-items-center">
            ...
            <h2 className="mt-3 text-white text-center text-[20px] md:text-[25px] lg:text-[30px]">
              <a href="/sample.xlsx" target="_blank">
                ...
                <tbody className="mx-[100px]">
                  {numberArray.map((num) => (
                    ...
                    >
                      ...
                      <td className="m-[30px] text-center">
                        {names.names[num]}
                      </td>
                      <td className="m-[30px] text-center">
                        {names.emails[num]}
