...
const Home = () => {
  return (
    <>
      <div
        className="flex flex-col gap-44 h-screen w-screen"
      ...
      >
        ...
        <div className="relative bottom-0 bg-transparent flex max-md:justify-center justify-end mr-24 max-sm:mr-0">
